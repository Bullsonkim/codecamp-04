...
import { IMutation, IMutationCreateBoardArgs, IQuery } from '../../src/commons/types/generated/types'
...
export default function GraphqlMutationProductPage(){
    ...
    const [createProduct] = useMutation <Pick <IMutation 'createProduct'> IMutationCreateBoardArgs> (CREATE_PRODUCT)
    async function zzz(){
        ...
        router.push(`/05-08-dynamic-product-read/${result.data.createProduct._id}`) //_id위치에서 원하는 정보 변경,템플릿 리터럴
